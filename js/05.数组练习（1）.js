...
//第六题
var num6 = [[2,25,20,68],[999,1,5,33,222],[6666,1,10,5,6],[99,88,44,1]];
var newnum6 = [];
for(i=0;i<num6.length;i++){
	newnum6 = newnum6.concat(num6[i]);
}
var newnum6 = newnum6.sort(function(a,b){return a-b;});
document.getElementById('show6').innerHTML = '这组数中最大值为：'+newnum6[newnum6.length-1]+'；最小值为：'+newnum6[0];
